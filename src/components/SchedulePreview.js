          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between py-2 border-b border-gray-200">
                ...
                <span className="font-semibold text-gray-900">{submittedData.patientName}</span>
              </div>
              {submittedData.medicines.map((medicine, index) => (
                <div key={index} className="py-4 border-b border-gray-200 last:border-b-0">
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    ...
                    <span className="font-semibold text-gray-900">{medicine.timesPerDay} time(s) per day</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-200">
                  ...
                  {medicine.startDate && (
                    <div className="flex justify-between py-2 border-b border-gray-200">
                      ...
                      <span className="font-semibold text-gray-900">{medicine.startDate}</span>
                    </div>
                  )}
                  {medicine.endDate && (
                    <div className="flex justify-between py-2">
                      <span className="font-medium text-gray-600">End Date:</span>
                      <span className="font-semibold text-gray-900">{medicine.endDate}</span>
                    </div>
                  )}
                </div>
              ))}
